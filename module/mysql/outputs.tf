...
# Complete SSH tunnel command, ready to paste. Opens a local port 3306 that
...
output "bastion_ssh_tunnel_command" {
  description = "Ready-to-run SSH tunnel command — forwards localhost:3306 to the RDS private endpoint"
