...
module/
  ...
  postgres/     # PostgreSQL 16 deployments (bastion SSH tunnel access)
  postgres-vpn/ # PostgreSQL 16 deployments (AWS Client VPN access)
  mysql/        # MySQL 8.0 deployments (bastion SSH tunnel access)
```
